...
const DUMMY_MEALS = [
  Meal(
    ...
    affordability: AffordabilityEnum.Affordable,
  ...
  Meal(
    ...
    affordability: AffordabilityEnum.Pricey,
    complexity: ComplexityEnum.Simple,
    imageUrl:
  ...
  Meal(
    ...
    affordability: AffordabilityEnum.Luxurious,
    complexity: ComplexityEnum.Challenging,
    imageUrl:
